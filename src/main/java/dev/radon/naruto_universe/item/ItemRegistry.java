...
public class ItemRegistry {
    ...
    public static final RegistryObject<ArmorItem> ANBU_CHEST = ITEMS.register("anbu_chestplate",
            () -> new ArmorItem(ArmorTiers.ANBU, EquipmentSlot.CHEST, new Item.Properties().tab(CreativeModeTab.TAB_COMBAT)));
    public static final RegistryObject<ArmorItem> ANBU_LEGGINGS = ITEMS.register("anbu_leggings",
            () -> new ArmorItem(ArmorTiers.ANBU, EquipmentSlot.LEGS, new Item.Properties().tab(CreativeModeTab.TAB_COMBAT)));
    public static final RegistryObject<ArmorItem> ANBU_BOOTS = ITEMS.register("anbu_boots",
            () -> new ArmorItem(ArmorTiers.ANBU, EquipmentSlot.FEET, new Item.Properties().tab(CreativeModeTab.TAB_COMBAT)));

    public static final RegistryObject<ArmorItem> DOG_ANBU_MASK = ITEMS.register("dog_anbu_mask",
            () -> new ArmorItem(ArmorTiers.DOG_ANBU_MASK, EquipmentSlot.HEAD, new Item.Properties().tab(CreativeModeTab.TAB_COMBAT)));

    public static final RegistryObject<KunaiItem> KUNAI = ITEMS.register("kunai",
            () -> new KunaiItem(new Item.Properties().durability(250).tab(CreativeModeTab.TAB_COMBAT)));
