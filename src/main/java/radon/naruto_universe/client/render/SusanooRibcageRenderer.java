...
public class SusanooRibcageRenderer extends SusanooStageRenderer<SusanooRibcageModel<SusanooEntity>> {
    ...
    public SusanooRibcageRenderer(EntityRendererProvider.Context pContext, SusanooRibcageModel<SusanooEntity> pModel, float pShadowRadius) {
